> **Documentación histórica y técnica de desarrollo.** Este archivo
> registra, fase a fase, las decisiones de diseño, contratos internos y
> validaciones realizadas durante el desarrollo del proyecto. No es la
> puerta de entrada del repositorio: para instalar, ejecutar la
> demostración o entender el producto, consulta el
> [`README.md`](../README.md) en la raíz del repositorio. Los
> identificadores `Pxx` (P01, P02, ...) referenciados aquí son fases
> internas de desarrollo, no conceptos que un lector externo necesite
> conocer.
...
en [`docs/data/serve_sequence_grammar_sources.md`](data/serve_sequence_grammar_sources.md).
